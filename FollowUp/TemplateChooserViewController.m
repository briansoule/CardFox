//
//  TemplateChooserViewController.m
//  FollowUp
//
...
@interface TemplateChooserViewController ()
...
- (void)viewDidLoad
{
    ...
    self.templates = @[@"SXSW", @"Angel Hack", @"YC Startup School", @"GMIC", @"Magic Camp"];
...
{
    self.delegate.letterCopy.text = @"<<name>>\n\nNice to meet you at YC Startup School.\n\nLet's get coffee soon.\n\nSincerely,\n<<myname>>";
